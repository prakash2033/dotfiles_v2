...
-- Create a calendar widget for clock hover/click
...
awful.spawn.with_shell("autorandr --load officedock")
awful.spawn.with_shell("setxkbmap -layout 'se,us'")
awful.spawn.with_shell("dropbox")
awful.spawn.with_shell("flameshot")
awful.spawn.with_shell("blueman-applet")
awful.spawn.with_shell("nm-applet")
awful.spawn.with_shell("geary --hidden")
awful.spawn.with_shell("redshift-gtk -l 57.708870:11.974560 -t 6500:3400 -m randr -v")
